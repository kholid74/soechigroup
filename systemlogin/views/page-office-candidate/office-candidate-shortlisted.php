			...
			<div class="animated fadeIn">
				...
				<div class="card-body">
                    ...
                    <div align="center">
	                    ...
	                    <a href="<?php echo $object->base_path()?>office-candidate-shortlisted" class="btn btn-outline-secondary active">
							...
							<table class="table table-responsive-sm table-bordered table-striped table-sm" id="example">
								...
								<tbody>
									...
									<?php 
								    	...
								    	$sql = "SELECT a.*,b.job_title FROM sch_candidate_office a JOIN sch_job_office b ON a.id_job = b.id WHERE a.status='1'";
									...
									<tr>
										...
										<td align="center">
											...
											<a class="btn btn-success btn-sm" href="<?php echo $object->base_path()?>office-candidate-shortlisted-details/<?= $cand['id'] ?>" title="View <?= $cand['full_name'] ?>">
