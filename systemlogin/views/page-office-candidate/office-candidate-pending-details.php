...
if($authadmin['level'] == '2'){
	...
	if(isset($_POST['_reject'])){ 
	    ...
	    $statusMsg =  $object->updatedata($namatable,$data,$conditions)?'successfully moved to rejected candidate.':'Some problem occurred, please try again.';
	    	...
	    	$insertHistory="INSERT INTO `sch_candidate_history` SET 
		      				`candidate_code`='".trim($candidate['candidate_code'])."', 
		      				`job_name`='".trim($candidate['job_title'])."',
		      				`status`='2',
	...
	if(isset($_POST['_reject'])){ 
	    ...
	    $conditions = array('id' =>strip_tags($_POST['id']));
	    $statusMsg =  $object->updatedata($namatable,$data,$conditions)?'success, waiting manager decision..':'Some problem occurred, please try again.';
...
<!-- Main content -->
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo $object->base_path()?>office-candidate-pending">Pending Candidate</a></li>
			...
			<div class="animated fadeIn">
				...
				<div class="card-body">
					...
					<!-- Main row -->
				      <div class="row">
				        <div class="col-lg-12">
				        <a href="<?php echo $object->base_path()?>office-candidate-pending" style="font-weight: bold;color: #084f93;"><i class="fa fa-chevron-left" aria-hidden="true"></i>&nbsp;&nbsp;BACK TO APPLICANT LIST</a>
				        <br><br>
			                  ...
			                  <div>
				                ...
				                <tbody>
				                  <?php 
				                    ...
				                    $sql = 'SELECT * FROM sch_cand_office_education WHERE graduated="sd" AND id_candidate="'.$_GET['ids'].'"';
							      ...
							      <div class="modal-body">
							       <form role="form" method="POST" enctype="multipart/form-data">
							          <div class="form-group">
										...
										<textarea name="_reason_reject" id="_reason_reject" cols="65" rows="4"></textarea>
