			...
			<div class="animated fadeIn">
				...
				<div class="card-body">
					...
					<div align="center">
	                    ...
	                    <a href="<?php echo $object->base_path()?>shipping-excrew-candidate-rejected" class="btn btn-outline-secondary active">
					...
					<table class="table table-responsive-sm table-bordered table-striped table-sm" id="example2">
						<thead>
							<tr>
						...
						<tbody>
							<?php 
						    	$sql = "SELECT a.*,b.name,c.short_name FROM sch_ex_candidate a JOIN sch_master_vessel b ON a.id_last_ship=b.id JOIN sch_master_crewrank c ON a.id_last_rank=c.id WHERE a.status='2'";
							...
							<tr>
								...
								<td align="center"><?= $cand['reason_reject'] ?></td>
								<td align="center"><?php echo $object->dateConvertEng($cand['ready_join_date']); ?></td>
								<td align="center">
									<a class="btn btn-success btn-sm" href="<?php echo $object->base_path()?>excrew-rejected-details/<?= $cand['id'] ?>" title="view <?= $cand['first_name'] ?> <?= $cand['last_name'] ?>">
