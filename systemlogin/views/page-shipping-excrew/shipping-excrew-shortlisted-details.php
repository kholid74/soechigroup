<?php 
    ...
    if(isset($_POST['_saveRemarks'])) {
    	...
    	echo "<script> window.location.assign('".$object->base_path()."excrew-shortlisted-details/".$candidate['id']."'); </script>";
  }
...
<!-- Main content -->
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo $object->base_path()?>shipping-excrew-candidate-shortlisted">Ex-Crew Details</a></li>
			...
			<div class="animated fadeIn">
				...
				<div class="card-body">
					...
					<!-- Main row -->
				      <div class="row">
				        <div class="col-lg-12">
				        <a href="<?php echo $object->base_path()?>shipping-excrew-candidate-shortlisted" style="font-weight: bold;color: #084f93;"><i class="fa fa-chevron-left" aria-hidden="true"></i>&nbsp;&nbsp;BACK TO CANDIDATE LIST</a>
				        <br><br>
