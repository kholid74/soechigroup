  <?php
    ...
    $sql  = 'SELECT * FROM sch_settings WHERE section="email_boc"';
    $data = $object->fetch($sql);
    if (!empty($data)){
    if(isset($_POST['_publish'])){ 
        $namatable = 'sch_settings';
        $data = array(
            'value'=>$_POST['value'],
      );
        ...
        echo "<script> window.location.assign('".$object->base_path()."master-email-boc'); </script>";
    }}
...
<!-- Main content -->
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Setting Email BOC</a></li>
	...
	<div class="container-fluid">
		<div id="ui-view" style="opacity: 1;">
			<div class="animated fadeIn">
				<h4 style="text-align: center"><i class="fa fa-settings"></i> SETTING EMAIL BOC</h4>
