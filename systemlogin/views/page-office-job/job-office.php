			...
			<div class="animated fadeIn">
				...
				<div class="card">
					<div class="card-header">
						<a href="<?php echo $object->base_path()?>add-job-office" class="btn btn-primary"><i class="fa fa-plus "></i>&nbsp;Add New Vacancy</a>
					</div>
				<div class="card-body">
					...
					<table class="table table-responsive-sm table-bordered table-striped table-sm" id="example">
						...
						<tbody>
							<?php 
						    	$sql = "SELECT * FROM sch_job_office ORDER BY modified ASC";
									...
									<div class="modal fade" id="share" tabindex="-1" role="dialog" aria-labelledby="share" aria-hidden="true">
									  <div class="modal-dialog modal-dialog-centered" role="document">
									    <div class="modal-content">
									      ...
									      <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo BASE_URL ?>detail-office/<?= $jobs['id'] ?>-<?php echo $object->sluggify($jobs['job_title']); ?>" target="_blank" title="Share to Facebook"><i class="fa fa-facebook-square fa-5x"></i></a>

										  <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo BASE_URL ?>detail-office/<?= $jobs['id'] ?>-<?php echo $object->sluggify($jobs['job_title']); ?>" target="_blank" title="Share to Linkedin"><i class="fa fa-linkedin-square fa-5x"></i></a>
							...
							<!-- END MODAL SHARE JOB -->
								...
								<td align="center">
									<a class="btn btn-info btn-sm" href="<?php echo $object->base_path()?>edit-job-office/<?php echo $jobs['id']?>">
									<i class="fa fa-edit"></i>
									</a>
									<a class="btn btn-danger btn-sm" href="<?php echo $object->base_path()?>delete-job-office/<?php echo $jobs['id']?>" onclick="return confirm('Confirm delete ?')" >
