          ...
          <li class="nav-title">
            ...
            MENU SHIPPING
              ...
              <li class="nav-item">
                ...
                <a class="nav-link <?php if($page == "shipping-excrew-candidate-pending" OR $page == "excrew-pending-details" OR $page == "shipping-excrew-candidate-shortlisted" OR $page == "shipping-candidate-shortlisted-details" OR $page == "shipping-excrew-candidate-rejected" OR $page == "shipping-excrew-candidate-rejected-details"){echo "active";}?>" href="<?php echo $object->base_path()?>shipping-excrew-candidate-pending"><i class="icon-anchor"></i>Ex-Crew</a>
