<?php 
    ...
    if(isset($_POST['_saveRemarks'])) {
    	...
    	echo "<script> window.location.assign('".$object->base_path()."shipping-candidate-interview-passed-detail/".$candidate['id']."'); </script>";
  }
...
<!-- Main content -->
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo $object->base_path()?>shipping-candidate-interview-passed">Passed Interview Candidate</a></li>
	...
	<div class="container-fluid">
		<div id="ui-view" style="opacity: 1;">
			<div class="animated fadeIn">
				<h4 style="text-align: center">PASSED INTERVIEW CANDIDATE</h4>
				...
				<div class="card-body">
					...
					<!-- Main row -->
				      <div class="row">
				        <div class="col-lg-12">
				        <a href="<?php echo $object->base_path()?>shipping-candidate-interview-passed" style="font-weight: bold;color: #084f93;"><i class="fa fa-chevron-left" aria-hidden="true"></i>&nbsp;&nbsp;BACK TO APPLICANT LIST</a>
				        <br><br>
