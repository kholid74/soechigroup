...
<!-- Main content -->
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Rejected Candidate</li>
                  ...
                  <label>Filter by :&nbsp;</label>
                    <select class="form-control" name="_jobvac" style="border-radius: 0px;">
                      ...
                      <?php 
                        ...
                        $sql = "SELECT a.*,b.id_job_name,c.name,d.status FROM sch_candidate_shipping a JOIN sch_job_shipping b ON a.id_job = b.id JOIN sch_master_crewrank c ON b.id_job_name=c.id JOIN sch_cand_shipping_status d ON a.candidate_code=d.candidate_code WHERE d.status='REJECTED' OR d.status='REJECT_MANAGER_DECISION'";
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Choose Action</h5>
