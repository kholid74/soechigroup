<?php 
    ...
    $candHistory  = "SELECT * FROM sch_candidate_history WHERE candidate_code='$canCode'";
    ...
    if(isset($_POST['_saveRemarks'])) {
    	...
    	echo "<script> window.location.assign('".$object->base_path()."shipping-candidate-rejected-detail/".$candidate['id']."'); </script>";
  }
	...
	if(isset($_POST['_shorlist'])){ 
        ...
        echo "<script> window.location.assign('".$object->base_path()."shipping-candidate-rejected'); </script>";
    }
...
<!-- Main content -->
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo $object->base_path()?>shipping-candidate-rejected">Rejected Candidate</a></li>
			...
			<div class="animated fadeIn">
				...
				<div class="card-body">
					...
					<!-- Main row -->
				      <div class="row">
				        <div class="col-lg-12">
				        <a href="<?php echo $object->base_path()?>shipping-candidate-rejected" style="font-weight: bold;color: #084f93;"><i class="fa fa-chevron-left" aria-hidden="true"></i>&nbsp;&nbsp;BACK TO APPLICANT LIST</a>
				        <br><br>
						...
						<ul class="nav nav-tabs" id="myTab" role="tablist">
						  ...
						  <li class="nav-item">
						    <a class="nav-link" id="candidate-history-tab" data-toggle="tab" href="#candidate-history" role="tab" aria-controls="candidate-history" aria-selected="false">Candidate History &nbsp;<span class='badge badge-danger'><?php echo $countHistory; ?></span></a>
						  </li>
						...
						<div class="tab-content" id="myTabContent">
			                    	...
			                    	<div class="col md-12">
				                    	<div class="timeline-centered">
				                    		<?php 
				                    			...
				                    			$candHistoryy  = "SELECT * FROM sch_candidate_history WHERE candidate_code='$canCode'";
						  ...
						  <div align="center">
							...
							<form role="form" method="POST" enctype="multipart/form-data">
								...
								<input type="submit" name="_shorlist" class="btn btn-flat btn-success" title="Proceed to shotlist candidate" onclick="return confirm('Process to shortlisted candidate ?');" value="RE-SHORTLISTED CANDIDATE" />
