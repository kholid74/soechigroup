...
<!-- Main content -->
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Interview Failed Candidate</li>
	...
	<div class="container-fluid">
		<div id="ui-view" style="opacity: 1;">
			<div class="animated fadeIn">
				<h4 style="text-align: center">INTERVIEW FAILED</h4>
				...
				<div class="card-body">
                    ...
                    <div align="center">
	                    ...
	                    <a href="<?php echo $object->base_path()?>shipping-candidate-interview-failed" class="btn btn-outline-secondary active">
							...
							<table class="table table-responsive-sm table-bordered table-striped table-sm" id="example">
								...
								<tbody>
									<?php
								    	...
								    	$sql = "SELECT a.*,b.id_job_name,c.name,d.status FROM sch_candidate_shipping a JOIN sch_job_shipping b ON a.id_job = b.id JOIN sch_master_crewrank c ON b.id_job_name=c.id JOIN sch_cand_shipping_status d ON a.candidate_code=d.candidate_code WHERE d.status='INTERVIEW_FAIL' AND c.name='$jobVac'";

										}else{

											$sql = "SELECT a.*,b.id_job_name,c.name,d.status FROM sch_candidate_shipping a JOIN sch_job_shipping b ON a.id_job = b.id JOIN sch_master_crewrank c ON b.id_job_name=c.id JOIN sch_cand_shipping_status d ON a.candidate_code=d.candidate_code WHERE d.status='INTERVIEW_FAIL'";
										}  
									...
									<tr>
										...
										<td><?= $cand['created'] ?></td>
										 <td align="center">
											<a class="btn btn-success btn-sm" href="<?php echo $object->base_path()?>shipping-candidate-interview-failed-detail/<?= $cand['id'] ?>" title="view <?= $cand['first_name'] ?> <?= $cand['last_name'] ?>">
