...
<!-- Main content -->
    <main class="main">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo $object->base_path()?>shipping-candidate-online-test">Online Test Candidate</a></li>
			...
			<div class="animated fadeIn">
				...
				<div class="card-body">
					...
					<!-- Main row -->
				      <div class="row">
				        <div class="col-lg-12">
				        <a href="<?php echo $object->base_path()?>shipping-candidate-online-test" style="font-weight: bold;color: #084f93;"><i class="fa fa-chevron-left" aria-hidden="true"></i>&nbsp;&nbsp;BACK TO APPLICANT LIST</a>
				        <br><br>
				            ...
				            <table style="font-weight: bold;line-height: 2;">
					            <tbody>
						            ...
						            <tr>
						              ...
						              <td>:&nbsp;</td>
						              <td>
						              	<span class='badge badge-primary'>INTERVIEW PROCESS & ONLINE TEST</span>
									  </td>
						            </tr>
					            </tbody>
				          </table>
