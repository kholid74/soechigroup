			...
			<div class="animated fadeIn">
				...
				<div class="card-body">
					...
					<div align="center">
	                    ...
	                    <a href="<?php echo $object->base_path()?>o-interview-schedule-rejected" class="btn btn-outline-secondary active">
					...
					<table class="table table-responsive-sm table-bordered table-striped table-sm" id="example">
						...
						<tbody>
							...
							<?php 
						    	...
						    	$sql = "SELECT a.*,b.full_name,b.email,b.candidate_code,c.job_title FROM sch_interview_schedule a JOIN sch_candidate_office b ON a.id_candidate = b.id JOIN sch_job_office c ON b.id_job=c.id WHERE a.category='office' AND a.status='2'";
							...
							<tr>
								...
								if(isset($_POST['_saveInterview'])) { 
							        ...
							        $message = str_replace("%cand['job_name']%", $cand['job_name'], $message);
							        ...
							        echo "<script> window.location.assign('".$object->base_path()."o-interview-schedule-rejected'); </script>";
							        ...
							        <div class="modal-dialog modal-dialog-centered" role="document">
							          ...
							          <div class="modal-content">
							            ...
							            <div class="modal-header">
							              ...
							              <h5 class="modal-title" id="exampleModalLongTitle">Set Schedule for <?= $cand['full_name'] ?></h5>
