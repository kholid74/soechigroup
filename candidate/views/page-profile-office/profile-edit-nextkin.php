				      ...
				      <div class="row">
				          ...
				          <div class="col-md-8 offset-md-2">
			                ...
			                <div class="form-group row">
			                  ...
			                  <div class="col-sm-8">
			                    <textarea name="address" class="form-control" cols="10" rows="3"><?= $nextKin['address'] ?></textarea>
			                  </div>
			                </div>
						  ...
						  <div class="form-group row">
			                  <label for="dependents" class="col-sm-4 col-form-label">Dependents*</label>
			                  <div class="col-sm-8">
				          ...
				          <div class="col-md-8 offset-md-2" align="center">
							...
							<a href="<?php echo $object->base_path()?>edit-profile-1/<?=$candidate['id']?>" class="btn btn-flat btn-primary">BACK</a>
