						...
						<div class="tab-content" id="myTabContent">
						  ...
						  <div class="tab-pane fade" id="formaleducation" role="tabpanel" aria-labelledby="attach-tab">
				              ...
				              <br>
				                ...
				                <tbody>
				                  <?php 
				                  $sql = 'SELECT a.*,b.nama_provinsi,c.nama_kabupaten FROM sch_cand_office_education a JOIN sch_provinsi b ON a.province=b.id_prov JOIN sch_kabupaten c ON a.city=c.id_kab WHERE graduated="smp" AND id_candidate="'.$authadmin['id'].'"';
				                  $exp = $object->fetch_all($sql);
				                  if (count($exp) > 0) {
				                    foreach ($exp as $smp) {?>
				                  <tr>
				              ...
				              <p align="center" style="font-weight: bold;">Sekolah Menengah Atas / Senior High School</p>
				                ...
				                <tbody>
				                  <?php 
				                  $sql = 'SELECT a.*,b.nama_provinsi,c.nama_kabupaten FROM sch_cand_office_education a JOIN sch_provinsi b ON a.province=b.id_prov JOIN sch_kabupaten c ON a.city=c.id_kab WHERE graduated="sma" AND id_candidate="'.$authadmin['id'].'"';
				                  $exp = $object->fetch_all($sql);
				                  if (count($exp) > 0) {
				                    foreach ($exp as $univ) {?>
				                  <tr>
				              ...
				              <p align="center" style="font-weight: bold;">Universitas / University</p>
				                ...
				                <tbody>
				                  <?php 
				                  $sql = 'SELECT a.*,b.nama_provinsi,c.nama_kabupaten FROM sch_cand_office_education a JOIN sch_provinsi b ON a.province=b.id_prov JOIN sch_kabupaten c ON a.city=c.id_kab WHERE graduated !="smp" AND graduated !="sma" AND id_candidate="'.$authadmin['id'].'"';
				                  $exp = $object->fetch_all($sql);
				                  if (count($exp) > 0) {
				                    foreach ($exp as $univ) {?>
				                  <tr>
