<?php
  ...
  $sqlSch = "SELECT a.*,b.full_name,b.email FROM sch_interview_schedule a JOIN sch_candidate_office b ON a.id_candidate = b.id WHERE a.id_candidate=".$authadmin['id']."";
...
<!-- Main content -->
                          ...
                          <div class="card-header">
                            ...
                            <div class="card-body" style="background-color: #f0f3f5">
                              ...
                              <div class="form-group">
                                ...
                                <h6 style="font-weight: bold;text-transform: uppercase;"><?= $candidate['full_name'] ?></h6>
                              </div>

                              <div class="form-group">
                                <label for="position">Position</label>
                                <h6 style="font-weight: bold;text-transform: uppercase;"><?= $candidate['job_title'] ?></h6>
                              </div>
   ...
   <?php 
    ...
    if(isset($_POST['_sendMail'])){
        ...
        $message = str_replace("%cand['full_name']%", $showSch['full_name'], $message);
        $message = str_replace("%cand['job_name']%", $showSch['job_name'], $message);
        $message = str_replace("%cand['date']%", $showSch['date'], $message);
        $message = str_replace("%cand['time']%", $showSch['time'], $message);
        ...
        $mail->addAddress(''.$showSch['email'].'', ''.$showSch['full_name'].'');    
