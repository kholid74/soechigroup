    ...
    if(isset($_POST['_update'])){
    	...
    	if (!empty($_FILES["photo"]["name"])) {
            ...
            if($fileSize < $maxsize){
        		...
        		echo "<script> window.location.assign('".$object->base_path()."nex-of-kin-details'); </script>";
            }else{
                $object->messagesfile();
                echo "<script> window.location.assign('".$object->base_path()."personal-data'); </script>";
            }
					...
					<!-- Main row -->
				      <div class="row">
				          <div class="col-md-12">
				          	<div id="smartwizard" class="sw-main sw-theme-circles" align="center">
                                <ul class="nav nav-tabs step-anchor">
                                    <li class="nav-item active"><a href="#personal-data" class="nav-link" style="">PERSONAL DATA /<br> <i>Data Pribadi</i></a></li>
						...
						<form role="form" method="POST" enctype="multipart/form-data">
							...
							<br>
							<input type="file" name="photo" class="form-control c-square c-theme" accept=".jpg,.png" onchange="document.getElementById('preview').src = window.URL.createObjectURL(this.files[0])" <?php if(empty($candidate['photo'])){echo "required";}else{echo "";} ?>>
							<center><small style="color: black;"><i>*Recomended 250 x 250 px.</i></small></center>
						</div>
				          <div class="col-md-8">

				          	<div class="form-group row">
			                  <label for="email" class="col-sm-4 col-form-label">Alamat Email / <i>Email address*</i></label>
			                  <div class="col-sm-8">
				          	...
				          	<div class="form-group row">
			                  <label for="idCard" class="col-sm-4 col-form-label">Identitas (KTP/Passport) / <i>ID (KTP/Passport)*</i></label>
			                  <div class="col-sm-8">
			                ...
			                <div class="form-group row">
			                  <label for="firstName" class="col-sm-4 col-form-label">Nama Depan / <i>First Name*</i></label>
			                  <div class="col-sm-8">
			                ...
			                <div class="form-group row">
			                  <label for="placeofBirth" class="col-sm-4 col-form-label">Tempat Lahir / <i>Place of Birth*</i></label>
			                  <div class="col-sm-8">
			                ...
			                <div class="form-group row">
			                  <label for="inputPassword" class="col-sm-4 col-form-label">Jenis Kelamin / <i>Gender*</i></label>
			                  <div class="col-sm-8">
			                ...
			                <div class="form-group row">
			                  <label for="inputPassword" class="col-sm-4 col-form-label">Status Pernikahan / <i>Marital Status*</i></label>
			                  <div class="col-sm-8">
							...
							<div class="form-group row">
			                  ...
			                  <div class="col-sm-8">
			                    <textarea name="address" class="form-control" cols="20" rows="5" required><?= $candidate['address'] ?></textarea>
			                  </div>
			                </div>

			                <div class="form-group row">
			                  <label for="inputPassword" class="col-sm-4 col-form-label">Kebangsaan  / <i>Nationality*</i></label>
			                  <div class="col-sm-8">
			                ...
			                <div class="form-group row">
			                  <label for="city" class="col-sm-4 col-form-label">Kota / <i>City*</i></label>
			                  <div class="col-sm-8">
			                ...
			                <div class="form-group row">
			                  <label for="mobile1" class="col-sm-4 col-form-label">Nomor HP 1 / <i>Mobile Number 1*</i></label>
			                  <div class="col-sm-8">
			                ...
			                <div class="form-group row">
			                  <label for="mobile2" class="col-sm-4 col-form-label">Nomor HP 2 / <i>Mobile Number 2*</i></label>
			                  <div class="col-sm-8">
			                ...
			                <div class="form-group row">
			                  <label for="nearest_airport" class="col-sm-4 col-form-label">Bandara Terdekat / <i>Nearest Airport*</i></label>
			                  <div class="col-sm-8">
