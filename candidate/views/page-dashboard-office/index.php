<?php 
  ...
  $sql5 = "SELECT status FROM sch_candidate_office WHERE id=".$authadmin['id']."";
            ...
            <div class="col-sm-6 col-lg-4">
              ...
              <div class="card text-white bg-success">
                <div class="card-body pb-0" align="center" style="height: 245px;">
                  ...
                  <?php if($showStatus['status'] == '4' OR $showStatus['status'] == '5') { ?>
              ...
              <div class="card text-black" style="background-color: #dadbdc">
                <div class="card-body pb-0" align="left">
                  ...
                  <ul>
                    ...
                    <li>Please upload the required documents to set up the interview schedule.</li>
                  </ul>
                  <br>
