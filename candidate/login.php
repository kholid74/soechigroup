...
<head>
  ...
  <title>Soechi Lines - Candidate Login</title>
  ...
  <!-- Styles required by this views -->
            ...
            <?php
              ...
              {
                  $email =  stripslashes(strip_tags($_POST['_email']));
                  $upass =  stripslashes(strip_tags($_POST['_password']));

                  if (strlen($upass) >= 8) {
                  if($auth->loginCandidate($email,$upass)){
        ...
        <div class="card-group">
          <div class="card p-4" style="background-color: #034e93;">
            <div class="card-body">
              ...
              <form role="form" method="POST" enctype="multipart/form-data">
                ...
                <input type="email" class="form-control" name="_email"  placeholder="Email" required autocomplete="on">
              </div>
              ...
              <div class="row">
                <div class="col-6">
                  <input type="submit" class="btn btn-primary px-4" style="color: #034e93;background-color: #ffffff;border-color: #ffffff;" name="login" value="Login">
                </div>
              </form>
          ...
          <div class="card text-white bg-primary py-5 d-md-down-none" style="width:44%;background-color: #FFFFFF!important;">
            <div class="card-body text-center">
              <div>
                <h2 style="color: #000000">CANDIDATE LOGIN</h2>
                <p style="color: #000000">Welcome to Soechi Lines Candidate Login</p>
