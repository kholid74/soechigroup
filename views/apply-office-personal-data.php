   <?php
    ...
    if(isset($_POST['_submit'])){ 
        ...
        $data = array(
              ...
              'ethnic_other'=>trim($_POST['ethnic_other']),
            ...
            <form role="form" method="POST" enctype="multipart/form-data">
              ...
              <div style="padding: 30px;">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" value="<?= $showJob['job_title'] ?>" disabled>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="fullName" name="fullName" value="<?= $showCand['full_name']; ?>" required>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input autocomplete="off" type="text" onkeypress="return isNumber(event)" class="form-control" id="idcardNumber" name="idcardNumber" value="<?= $showCand['idcard_number']; ?>" required>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input autocomplete="off" type="text" onkeypress="return isNumber(event)" class="form-control" id="taxNumber" name="taxNumber" value="<?= $showCand['tax_number']; ?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input autocomplete="off" type="text" onkeypress="return isNumber(event)" class="form-control" id="passportNumber" name="passportNumber" value="<?= $showCand['passport_number']; ?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <select class="form-control" id="cityzenship" name="cityzenship" required>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <select class="form-control" id="ethnic" name="ethnic" onchange="checkvalueethnic(this.value)">
                      <option selected>------Please Select Below------</option>
                      ...
                      <option value="OTHER" <?php if($showCand['ethnic'] == "OTHER"){echo "selected";} ?>>OTHER</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group row"  >
                  ...
                  <div class="col-sm-8" id="ethnic_other" style="<?php if($showCand['ethnic'] != "OTHER"){echo "display: none";} ?>">
                    <input type="text" class="form-control" id="ethnic_other" name="ethnic_other" value="<?= $showCand['ethnic_other'] ?>" placeholder="Please input ethnic" <?php if($showCand['ethnic'] == "OTHER"){echo "required";} ?>>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <select class="form-control" id="religion" name="religion" required onchange="checkvaluereligion(this.value)">
                      <option selected>------Please Select Below------</option>
                      ...
                      <option value="OTHER" <?php if($showCand['religion'] == "OTHER"){echo "selected";} ?>>OTHER</option>
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group row" >
                  ...
                  <div class="col-sm-8" id="religion_other" style="<?php if($showCand['religion'] != "OTHER"){echo "display: none";} ?>">
                    <input type="text" class="form-control" id="religion_other" name="religion_other" value="<?= $showCand['religion_other'] ?>" placeholder="Please input religion" <?php if($showCand['religion'] == "OTHER"){echo "required";} ?>>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="salary" name="salary" value="<?= $showCand['expected_salary'] ?>" required>
                  </div>
                </div>
